...
protected:
	...
	static int __cdecl _CompareAscending(const void* p1, const void* p2);
	static int __cdecl _CompareDescending(const void* p1, const void* p2);
...
template <class TYPE, class ARG_TYPE>
int __cdecl CArrayEx<TYPE, ARG_TYPE>::_CompareAscending(const void* p1, const void* p2)
{
...
template <class TYPE, class ARG_TYPE>
int __cdecl CArrayEx<TYPE, ARG_TYPE>::_CompareDescending(const void* p1, const void* p2)
{
