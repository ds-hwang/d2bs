...
enum unit_tinyid {
	...
	UNIT_CHARLVL, WINAMP_TRACK, ME_RUNWALK, UNIT_ADDRESS, ITEM_CODE, ITEM_PREFIX,
	...
	UNIT_SPECTYPE, ITEM_DESC, ITEM_BODYLOCATION, UNIT_ITEMCOUNT,
	UNIT_OWNER, UNIT_OWNERTYPE, ITEM_LEVEL, UNIT_DIRECTION, ITEM_SUFFIXNUM, ITEM_PREFIXNUM,
	OBJECT_TYPE
};
