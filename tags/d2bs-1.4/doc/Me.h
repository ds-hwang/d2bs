/** The class that represents the controlled unit. Technically, also called
 * Unit, but since C++ doesn't support class overloading, called it Me here
 * instead.
 */
class Me
{
public:
	 ...
	 *
	 * \todo Figure out what this represents.
	 */
	double gamestarttime;

	/** The game type, expansion or not.
	 *
	 * \todo Determine what the values are.
	 */
	int gametype;
	 ...
	 *
	 * \todo Determine the difference between this and realm.
	 */
	String realmshort;
	...
	/** The window size.
	 *
	 * \todo Determine what the numbers mean.
	 */
	int screensize;
	 ...
	 *
	 * \todo Determine when this is different from gameReady. Maybe when going
	 * between acts for instance.
	 */
	bool ingame;

	/** Whether or not to quit when there's an error.
	 *
	 * \todo Figure out if this means js errors.
	 */
	bool quitonerror;
