...
#define p_D2CLIENT_NoPickup GetD2ClientNoPickup()
...
#define p_D2CLIENT_AutomapOn_I GetD2ClientAutomapOn_I()
#define p_D2CLIENT_AutomapOn_II GetD2ClientAutomapOn_II()
