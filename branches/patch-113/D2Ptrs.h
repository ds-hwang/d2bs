...
VARPTR(D2CLIENT, ViewportY, int, 0x11995C)
VARPTR(D2CLIENT, ViewportX, int, 0x119960)
...
FUNCPTR(BNCLIENT, DecodeAndLoadKeys, char __cdecl, (), 0x162B0)
...
VARPTR(BNCLIENT, ClassicKey, char*, 0x1E8D8)
VARPTR(BNCLIENT, XPacKey, char*, 0x1E8E0)
VARPTR(BNCLIENT, KeyOwner, char*, 0x1E8E4)


#define _D2PTRS_END	p_BNCLIENT_KeyOwner
